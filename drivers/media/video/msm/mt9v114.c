...
static struct mt9v114_i2c_reg_conf mt9v114_init_reg_config[] =
{
    ...
    // AWB-CCM
    {E_REGISTER_CMD_16BIT, 0xA02F, 0x0468}, // CAM_AWB_CONFIG_CCM_L_0
    {E_REGISTER_CMD_16BIT, 0xA045, 0x0136}, // CAM_AWB_CONFIG_CCM_RL_0
    {E_REGISTER_CMD_16BIT, 0xA031, 0xFD7D}, // CAM_AWB_CONFIG_CCM_L_1
    {E_REGISTER_CMD_16BIT, 0xA047, 0xFE9C}, // CAM_AWB_CONFIG_CCM_RL_1
    {E_REGISTER_CMD_16BIT, 0xA033, 0xFF73}, // CAM_AWB_CONFIG_CCM_L_2
    {E_REGISTER_CMD_16BIT, 0xA049, 0x006F}, // CAM_AWB_CONFIG_CCM_RL_2
    {E_REGISTER_CMD_16BIT, 0xA035, 0xFDD5}, // CAM_AWB_CONFIG_CCM_L_3
    {E_REGISTER_CMD_16BIT, 0xA04B, 0x00CE}, // CAM_AWB_CONFIG_CCM_RL_3
    {E_REGISTER_CMD_16BIT, 0xA037, 0x03FC}, // CAM_AWB_CONFIG_CCM_L_4
    {E_REGISTER_CMD_16BIT, 0xA04D, 0xFF39}, // CAM_AWB_CONFIG_CCM_RL_4
    {E_REGISTER_CMD_16BIT, 0xA039, 0xFFBF}, // CAM_AWB_CONFIG_CCM_L_5
    {E_REGISTER_CMD_16BIT, 0xA04F, 0xFFF6}, // CAM_AWB_CONFIG_CCM_RL_5
    {E_REGISTER_CMD_16BIT, 0xA03B, 0xFE98}, // CAM_AWB_CONFIG_CCM_L_6
    {E_REGISTER_CMD_16BIT, 0xA051, 0x0100}, // CAM_AWB_CONFIG_CCM_RL_6
    {E_REGISTER_CMD_16BIT, 0xA03D, 0xFB95}, // CAM_AWB_CONFIG_CCM_L_7
    {E_REGISTER_CMD_16BIT, 0xA053, 0x0276}, // CAM_AWB_CONFIG_CCM_RL_7
    {E_REGISTER_CMD_16BIT, 0xA03F, 0x0748}, // CAM_AWB_CONFIG_CCM_L_8
    {E_REGISTER_CMD_16BIT, 0xA055, 0xFC66}, // CAM_AWB_CONFIG_CCM_RL_8
    ...
    {E_REGISTER_CMD_16BIT, 0x3640, 0x02D0},
    {E_REGISTER_CMD_16BIT, 0x3642, 0x6D4B},
    {E_REGISTER_CMD_16BIT, 0x3644, 0x5DB0},
    {E_REGISTER_CMD_16BIT, 0x3646, 0xF60C},
    {E_REGISTER_CMD_16BIT, 0x3648, 0xF4AE},
    {E_REGISTER_CMD_16BIT, 0x364A, 0x0330},
    {E_REGISTER_CMD_16BIT, 0x364C, 0x148C},
    {E_REGISTER_CMD_16BIT, 0x364E, 0x6B10},
    {E_REGISTER_CMD_16BIT, 0x3650, 0x95AD},
    {E_REGISTER_CMD_16BIT, 0x3652, 0xD50E},
    {E_REGISTER_CMD_16BIT, 0x3654, 0x02B0},
    {E_REGISTER_CMD_16BIT, 0x3656, 0x020C},
    {E_REGISTER_CMD_16BIT, 0x3658, 0x5F30},
    {E_REGISTER_CMD_16BIT, 0x365A, 0xA80C},
    {E_REGISTER_CMD_16BIT, 0x365C, 0x998F},
    {E_REGISTER_CMD_16BIT, 0x365E, 0x06D0},
    {E_REGISTER_CMD_16BIT, 0x3660, 0x108C},
    {E_REGISTER_CMD_16BIT, 0x3662, 0x63D0},
    {E_REGISTER_CMD_16BIT, 0x3664, 0xF94C},
    {E_REGISTER_CMD_16BIT, 0x3666, 0xA6CE},
    {E_REGISTER_CMD_16BIT, 0x3680, 0x930B},
    {E_REGISTER_CMD_16BIT, 0x3682, 0x50A8},
    {E_REGISTER_CMD_16BIT, 0x3684, 0x576E},
    {E_REGISTER_CMD_16BIT, 0x3686, 0x0B6A},
    {E_REGISTER_CMD_16BIT, 0x3688, 0xBDAF},
    {E_REGISTER_CMD_16BIT, 0x368A, 0xAACA},
    {E_REGISTER_CMD_16BIT, 0x368C, 0x5AE7},
    {E_REGISTER_CMD_16BIT, 0x368E, 0x1D0E},
    {E_REGISTER_CMD_16BIT, 0x3690, 0x60ED},
    {E_REGISTER_CMD_16BIT, 0x3692, 0xD94F},
    {E_REGISTER_CMD_16BIT, 0x3694, 0xF0CA},
    {E_REGISTER_CMD_16BIT, 0x3696, 0xC3CA},
    {E_REGISTER_CMD_16BIT, 0x3698, 0x6C4D},
    {E_REGISTER_CMD_16BIT, 0x369A, 0x1F0C},
    {E_REGISTER_CMD_16BIT, 0x369C, 0xB76E},
    {E_REGISTER_CMD_16BIT, 0x369E, 0x972B},
    {E_REGISTER_CMD_16BIT, 0x36A0, 0xC08A},
    {E_REGISTER_CMD_16BIT, 0x36A2, 0x756E},
    {E_REGISTER_CMD_16BIT, 0x36A4, 0x1BAD},
    {E_REGISTER_CMD_16BIT, 0x36A6, 0xEF4F},
    {E_REGISTER_CMD_16BIT, 0x36C0, 0x5B70},
    {E_REGISTER_CMD_16BIT, 0x36C2, 0x816D},
    {E_REGISTER_CMD_16BIT, 0x36C4, 0x97F2},
    {E_REGISTER_CMD_16BIT, 0x36C6, 0x806F},
    {E_REGISTER_CMD_16BIT, 0x36C8, 0x3893},
    {E_REGISTER_CMD_16BIT, 0x36CA, 0x6E10},
    {E_REGISTER_CMD_16BIT, 0x36CC, 0x9F4D},
    {E_REGISTER_CMD_16BIT, 0x36CE, 0xB4F2},
    {E_REGISTER_CMD_16BIT, 0x36D0, 0x8AAF},
    {E_REGISTER_CMD_16BIT, 0x36D2, 0x5F53},
    {E_REGISTER_CMD_16BIT, 0x36D4, 0x6A30},
    {E_REGISTER_CMD_16BIT, 0x36D6, 0xD9AC},
    {E_REGISTER_CMD_16BIT, 0x36D8, 0xA892},
    {E_REGISTER_CMD_16BIT, 0x36DA, 0xD46E},
    {E_REGISTER_CMD_16BIT, 0x36DC, 0x3BD3},
    {E_REGISTER_CMD_16BIT, 0x36DE, 0x5AD0},
    {E_REGISTER_CMD_16BIT, 0x36E0, 0x82ED},
    {E_REGISTER_CMD_16BIT, 0x36E2, 0x9052},
    {E_REGISTER_CMD_16BIT, 0x36E4, 0x8D0F},
    {E_REGISTER_CMD_16BIT, 0x36E6, 0x30B3},
    {E_REGISTER_CMD_16BIT, 0x3700, 0x436D},
    {E_REGISTER_CMD_16BIT, 0x3702, 0x5CAD},
    {E_REGISTER_CMD_16BIT, 0x3704, 0x97F1},
    {E_REGISTER_CMD_16BIT, 0x3706, 0x9E50},
    {E_REGISTER_CMD_16BIT, 0x3708, 0x7CB2},
    {E_REGISTER_CMD_16BIT, 0x370A, 0x29AB},
    {E_REGISTER_CMD_16BIT, 0x370C, 0x6B2E},
    {E_REGISTER_CMD_16BIT, 0x370E, 0xCCB1},
    {E_REGISTER_CMD_16BIT, 0x3710, 0xBE31},
    {E_REGISTER_CMD_16BIT, 0x3712, 0x1AD3},
    {E_REGISTER_CMD_16BIT, 0x3714, 0xBCAB},
    {E_REGISTER_CMD_16BIT, 0x3716, 0x372E},
    {E_REGISTER_CMD_16BIT, 0x3718, 0xB5F0},
    {E_REGISTER_CMD_16BIT, 0x371A, 0xCE70},
    {E_REGISTER_CMD_16BIT, 0x371C, 0x1032},
    {E_REGISTER_CMD_16BIT, 0x371E, 0x6CED},
    {E_REGISTER_CMD_16BIT, 0x3720, 0x7EAE},
    {E_REGISTER_CMD_16BIT, 0x3722, 0xB311},
    {E_REGISTER_CMD_16BIT, 0x3724, 0xB291},
    {E_REGISTER_CMD_16BIT, 0x3726, 0x2473},
    {E_REGISTER_CMD_16BIT, 0x3740, 0xBF4E},
    {E_REGISTER_CMD_16BIT, 0x3742, 0xBDAF},
    {E_REGISTER_CMD_16BIT, 0x3744, 0x7853},
    {E_REGISTER_CMD_16BIT, 0x3746, 0x7332},
    {E_REGISTER_CMD_16BIT, 0x3748, 0x9795},
    {E_REGISTER_CMD_16BIT, 0x374A, 0x8D2F},
    {E_REGISTER_CMD_16BIT, 0x374C, 0xF98F},
    {E_REGISTER_CMD_16BIT, 0x374E, 0x17F4},
    {E_REGISTER_CMD_16BIT, 0x3750, 0x2973},
    {E_REGISTER_CMD_16BIT, 0x3752, 0xAE75},
    {E_REGISTER_CMD_16BIT, 0x3754, 0x926F},
    {E_REGISTER_CMD_16BIT, 0x3756, 0xB18F},
    {E_REGISTER_CMD_16BIT, 0x3758, 0x5853},
    {E_REGISTER_CMD_16BIT, 0x375A, 0x6EF2},
    {E_REGISTER_CMD_16BIT, 0x375C, 0xF4B4},
    {E_REGISTER_CMD_16BIT, 0x375E, 0x822F},
    {E_REGISTER_CMD_16BIT, 0x3760, 0x8950},
    {E_REGISTER_CMD_16BIT, 0x3762, 0x0194},
    {E_REGISTER_CMD_16BIT, 0x3764, 0x2453},
    {E_REGISTER_CMD_16BIT, 0x3766, 0xA435},
    {E_REGISTER_CMD_16BIT, 0x3782, 0x00CC},
    {E_REGISTER_CMD_16BIT, 0x3784, 0x0118},
    ...
    {E_REGISTER_CMD_8BIT,  0xA088,   0x18}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_1
    {E_REGISTER_CMD_8BIT,  0xA089,   0x25}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_2
    {E_REGISTER_CMD_8BIT,  0xA08A,   0x3a}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_3
    {E_REGISTER_CMD_8BIT,  0xA08B,   0x59}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_4
    {E_REGISTER_CMD_8BIT,  0xA08C,   0x70}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_5
    {E_REGISTER_CMD_8BIT,  0xA08D,   0x81}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_6
    {E_REGISTER_CMD_8BIT,  0xA08E,   0x90}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_7
    {E_REGISTER_CMD_8BIT,  0xA08F,   0x9e}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_8
    {E_REGISTER_CMD_8BIT,  0xA090,   0xab}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_9
    {E_REGISTER_CMD_8BIT,  0xA091,   0xb6}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_10
    {E_REGISTER_CMD_8BIT,  0xA092,   0xc1}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_11
    {E_REGISTER_CMD_8BIT,  0xA093,   0xcb}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_12
    {E_REGISTER_CMD_8BIT,  0xA094,   0xd5}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_13
    {E_REGISTER_CMD_8BIT,  0xA095,   0xde}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_14
    {E_REGISTER_CMD_8BIT,  0xA096,   0xe7}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_15
    {E_REGISTER_CMD_8BIT,  0xA097,   0xef}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_16
    {E_REGISTER_CMD_8BIT,  0xA098,   0xf7}, // CAM_LL_CONFIG_GAMMA_CONTRAST_CURVE_17
...
{
    {E_REGISTER_CMD_8BIT,  0x9401, 0x0C}, // AWB_MODE
    {E_REGISTER_CMD_8BIT,  0x9436, 0x52},     // AWB_R_RATIO_PRE_AWB0x57
...
static struct mt9v114_i2c_reg_conf mt9v114_wb_cloudy_reg_config[] =
{
    ...
    {E_REGISTER_CMD_8BIT,  0x9401, 0x0C}, // AWB_MODE
    {E_REGISTER_CMD_8BIT,  0x9436, 0x45},     // AWB_R_RATIO_PRE_AWB 0x42
    {E_REGISTER_CMD_8BIT,  0x9437, 0x5a}, // AWB_B_RATIO_PRE_AWB 0x56
