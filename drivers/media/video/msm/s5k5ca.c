...
static struct s5k5ca_i2c_reg_conf s5k5ca_max_12fps[] =
{
    {0x0028,0x7000},
    {0x002A,0x0288},
    {0x0F12,0X04e2},
...
static struct s5k5ca_i2c_reg_conf s5k5ca_max_15fps[] =
{
    {0x0028,0x7000},
    {0x002A,0x0288},
    {0x0F12,0X04e2},
...
int32_t s5k5ca_set_fps(struct fps_cfg    *fps)
{
    ...
    {
        rc = s5k5ca_i2c_write_w_table(s5k5ca_max_12fps, 
            sizeof(s5k5ca_max_12fps)/sizeof(s5k5ca_max_12fps[0]));
    }
    else if(fps->f_mult == NORMAL_MODE_FPS)
    {
        rc = s5k5ca_i2c_write_w_table(s5k5ca_max_15fps, 
            sizeof(s5k5ca_max_15fps)/sizeof(s5k5ca_max_15fps[0]));
    }
